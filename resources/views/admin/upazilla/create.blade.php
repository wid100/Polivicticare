                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.upazilla.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Upazilla list</label>
                                        {{-- select  --}}
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">New Upazilla Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="name" name="upazilla_name"
