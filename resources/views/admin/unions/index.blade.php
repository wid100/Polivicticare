    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb d-flex align-center justify-content-between">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Unions List Table</li>
            </ol>
            <a href="{{ route('admin.union.create') }}" class="btn btn-primary">Create
                Unions </a>
        </nav>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::user()->role_id == 1)
                                                    <form id="delete_form_{{ $item->id }}"
                                                        action="{{ route('admin.union.destroy', $item->id) }}"
